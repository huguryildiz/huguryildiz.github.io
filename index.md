...
<div class="shell">
  ...
  <ul class="newslist">
    ...
    <li><time datetime="{{ post.date | date_to_xmlschema }}">{{ post.date | date: "%b %-d, %Y" }}</time><svg class="nicon" aria-hidden="true"><use href="#i-pen"/></svg><span>Writing: <a href="{{ post.url | relative_url }}">{{ post.title }}</a>.</span></li>
    {%- endfor %}
